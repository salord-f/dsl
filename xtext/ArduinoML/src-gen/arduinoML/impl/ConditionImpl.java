 ...
 *   <li>{@link arduinoML.impl.ConditionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link arduinoML.impl.ConditionImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends NamedElementImpl implements Condition {
	...
	public NotificationChain basicSetSignal(Signal newSignal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ArduinoMLPackage.CONDITION__SIGNAL, oldSignal, newSignal);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSignal != signal) {
			...
			if (signal != null)
				msgs = ((InternalEObject) signal).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - ArduinoMLPackage.CONDITION__SIGNAL, null, msgs);
			if (newSignal != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ArduinoMLPackage.CONDITION__SIGNAL, newSignal,
					newSignal));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ArduinoMLPackage.CONDITION__SIGNAL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ArduinoMLPackage.CONDITION__OPERATOR:
			return getOperator();
		case ArduinoMLPackage.CONDITION__SIGNAL:
			return getSignal();
		}
