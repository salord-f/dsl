java -jar target/borduino-1.0-jar-with-dependencies.jar src/test/resources/Alarm.bsl > output/alarm.ino
java -jar target/borduino-1.0-jar-with-dependencies.jar src/test/resources/DualAlarm.bsl > output/dual-alarm.ino
